...
#define RHI_FALSE                           false
    ...
    // Image的使用场景, 性能优化，对图像资源定制化配置
    enum RHIImageUsageFlagBits {
        RHI_IMAGE_USAGE_TRANSFER_SRC_BIT = 0x00000001,              // 传输源头
        RHI_IMAGE_USAGE_TRANSFER_DST_BIT = 0x00000002,              // 传输目标
        RHI_IMAGE_USAGE_SAMPLED_BIT = 0x00000004,                   // 采样
        RHI_IMAGE_USAGE_STORAGE_BIT = 0x00000008,                   // 存储
        RHI_IMAGE_USAGE_COLOR_ATTACHMENT_BIT = 0x00000010,          // color attachment
        RHI_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT = 0x00000020,  // depth / stencil attachment
        RHI_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT = 0x00000040,      // 临时附件
        RHI_IMAGE_USAGE_INPUT_ATTACHMENT_BIT = 0x00000080,          // input
        RHI_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT = 0x00000200,  // density map
        RHI_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = 0x00000100, // shading rate
        RHI_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI = 0x00040000,    // 华为设备
        RHI_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV = RHI_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR, // shading rate
